...
class PlayScene extends Phaser.Scene {
	...
	create() {
		...
		if (playerStart) {
			...
			this.player.setCurrentMap(tilemapManager); // Set the current map for the player
		}
	}
	...
	update() {
		...
		if (this.player) {
			...
			this.player.setCurrentMap(tilemapManager); // Update the current map for the player
		}
	}
